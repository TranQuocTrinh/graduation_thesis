...
def visualize_no_att(image_path, seq, rev_word_map):
    """
    ...
    plt.text(0, 0, ' '.join(words[1:-1]), color='black', backgroundcolor='white', fontsize=12)
    plt.imshow(image)
    plt.axis('off')
    plt.show()
...
if __name__ == '__main__':
    ...
    visualize_no_att(args.img, seq, rev_word_map)
